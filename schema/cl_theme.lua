...
function THEME:CreateFonts()
	Clockwork.fonts:Add("SW_Skip_Font", {
		font = "SW Crawl Body",
		size = 18,
		weight = 500
	});

	Clockwork.fonts:Add("SW_Episode_Font", {
		font = "SW Crawl Body",
		size = 60,
		weight = 500
	});

	Clockwork.fonts:Add("SW_Title_Font", {
		font = "SW Crawl Title",
		size = 200,
		weight = 500
	});
...
function THEME:Initialize()
	Clockwork.option:SetColor("information", Color(255, 255, 0));
end;
